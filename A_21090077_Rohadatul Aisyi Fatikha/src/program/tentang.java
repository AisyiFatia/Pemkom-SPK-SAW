...
public class tentang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Sistem ini dibangun untuk membantu pihak Pengunjung Perpustakaan untuk mencari buku yang di inginkan\n\t\n\nKriteria yang digunakan antara lain :\nTahun Terbit, Ketersediaan Buku, Resensi Buku, dan Minat Buku.\nBobot dari masing - masing kriteria adalah ( 25%, 25%, 25%, 25% )\n\nMetode yang digunakan adalah SAW (Simple Additive Weighting)");
